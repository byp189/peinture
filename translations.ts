...
export const translations = {
  en: {
    appTitle: "ABEI AI Image Gen",
    prompt: "Prompt",
    optimize: "Optimize",
    optimizing: "Optimizing...",
    optimizeTitle: "Enhance prompt with ABEI AI",
    promptPlaceholder: "ABEI AI...",
    model: "Model",
    ...
    galleryEmptyDesc: "Describe your vision and watch it come to life using ABEI AI.",
    ...
    settings: "Settings",
    hfToken: "ABEI AI Token",
    hfTokenHelp: "Optional. Provide",
    hfTokenLink: "Access Token",
    hfTokenHelpEnd: "to get more quota on ABEI AI",
    cancel: "Cancel",
    save: "Save",
    language: "Language",
    hd: "HD",
  ...
  zh: {
    ...
    optimize: "优化",
    optimizing: "优化中...",
    optimizeTitle: "使用 ABEI AI 优化提示词",
    promptPlaceholder: "ABEI AI 每天限量生成图片...",
    model: "模型",
    aspectRatio: "图片比例",
    seed: "种子",
    seedOptional: "可选",
    seedPlaceholder: "随机",
    generate: "ABEI AI 每天限量生成图片",
    dreaming: "生成中...",
    galleryEmptyTitle: "作品将显示在这里",
    galleryEmptyDesc: "描述您的构想，用 ABEI AI 将其变为现实。",
